...
- Always build for both **x86** and **ARM** architectures
- Always host the image on the **GitHub Container Registry (ghcr.io)**

## GitHub Workflow
- Always merge branches and pull requests and run the action for build
...
Add an "Updating" section to the GitHub README with the following:
